...
.endfor
	...
	# utils
.for util in get_assigned_rulesets find-number-from-start find-smallest-missing-number getservbyname ipcheck network jexec juexec mksock
